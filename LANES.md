...
| **S4 seam (DelegateOps)** | crosswalk [v0.2.3] registers the DelegateOps protocol as prospective S4 (zero mapping cells — pre-launch ledger, v0.2 sample rule); deliberation filed | pre-Task-15 probe, one session: hand-map S3's six event types + S4 protocol fields onto the crosswalk spine (value-level samples where live data exists) + grep the spine for fields presupposing a single decision-maker | flip condition in the proposal §4: projection loses learning-load-bearing fields ⇒ standard premature, adapter-per-pair stands | driver sessions | 2026-08-14 | [three-strains deliberation](docs/proposals/2026-08-14-three-strains-record-standard-deliberation.md) |
