...
| **S4 seam (DelegateOps)** | **probe EXECUTED same day ([P-20260814](probes/records/P-20260814-s4-crosswalk-mapping.md)): flip condition NOT met, standard stands**; delegateops OI-2 closable; S4 registered [v0.2.3] | operator/panel disposition of the recommended [v0.2.4] reservations: `candidates[]` + `assignment{}` (OPE precondition), `situation{}` (operator's situation-conditioned-routing direction, deliberation §5), S4 surface members, 5 new §3a disposition rows, S3 null-observed_model projector rule | v0.2 sample rule; S4 mid-build (Task 8b) so the mapping is provisional until Task 15 freezes fields | driver sessions | 2026-08-14 | [three-strains deliberation](docs/proposals/2026-08-14-three-strains-record-standard-deliberation.md) + probe record |
