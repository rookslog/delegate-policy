...
| [Family naming](2026-08-14-family-naming.md) | **DRAFT (2026-08-14) — awaiting operator ratification of N-1..N-4.** One brand (`delegate-` stem under DelegateOps, recommended), role-named members, the record spine named **Capsule** (in-house: Task 15 "Run Capsule"). The cheap reversible first move from the packaging deliberation; forecloses no structural option. | Operator decides N-1 (brand) and N-2..N-4; then P1→P4 migration, availability measured before P2, brand frozen at first npm publish. |
