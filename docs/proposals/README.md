...
| [Family naming](2026-08-14-family-naming.md) | **DRAFT (2026-08-14) — awaiting operator ratification of N-1..N-4.** Rev.2 recommends **brand-the-invariant: family = Capsule** (paradigm-neutral — the operator falsified rev.1's delegate-stem assumption), members role-named, `DelegateOps` persisting as the supervisor-runtime member name. The cheap reversible first move from the packaging deliberation; forecloses no structural option. | Operator decides N-1 (brand) and N-2..N-4; then P1→P4 migration, availability measured before P2, brand frozen at first npm publish. |
